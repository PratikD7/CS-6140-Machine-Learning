...
def gradient_descent(train_data, Y_train, n_iterations):
    ...
    for step in range(n_iterations):
        ...
        for row in train_data:
            ...
            # Increment the alpha if a mistake is made
...
def dual_perceptron(train_data, test_data, Y_train, Y_test, n_iterations, tolerance, learning_rate, flag):
    preds_train = []
    preds_test = []
...
def dual_perceptron_algorithm(ds, n_folds, n_iterations, tolerance, learning_rate, flag):
    ...
    for fold in folds:
        ...
        accuracy_train, precision_train, recall_train, accuracy_test, precision_test, recall_test = \
            dual_perceptron(train_data, test_data, Y_train, Y_test, n_iterations, tolerance, learning_rate, flag)
