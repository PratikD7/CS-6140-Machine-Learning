...
def main():
    ...
    pi_values_filenames = ['Top100_pi_values_smoothing.csv',
                           'Top500_pi_values_smoothing.csv',
                           'Top1000_pi_values_smoothing.csv',
                           'Top2500_pi_values_smoothing.csv',
                           'Top5000_pi_values_smoothing.csv',
                           'Top7500_pi_values_smoothing.csv',
                           'Top10000_pi_values_smoothing.csv',
                           'Top12500_pi_values_smoothing.csv']

    # theta_values_filenames = ['Top100_theta_values.csv']
    theta_values_filenames = ['Top100_theta_values_smoothing.csv',
                              'Top500_theta_values_smoothing.csv',
                              'Top1000_theta_values_smoothing.csv',
                              'Top2500_theta_values_smoothing.csv',
                              'Top5000_theta_values_smoothing.csv',
                              'Top7500_theta_values_smoothing.csv',
                              'Top10000_theta_values_smoothing.csv',
                              'Top12500_theta_values_smoothing.csv']

    Y_pred_filenames = ['Top100.csv',
                        'Top500.csv',
                        'Top1000.csv',
                        'Top2500.csv',
                        'Top50000.csv',
                        ...
                        'Top10000.csv',
                        'Top12500.csv']
    # Y_pred_filenames = ['Top25000.csv']

    # Load the training data file
    dir = 'C:/Users/prati/PycharmProjects/MlPractice/Assignment 3/MB- Theta and Pi values files - Smoothing/'
    ...
    for vocabulary_size in vocabulary_size_list:
        ...
        # Calculate the den values for the formula of class prediction
        den = calculate_den_values_for_prediction(doc_word_dict, yik_dict, pi_k, top_words_ids, theta_jk)

        # Prediction function
        Y_pred, Y_actual = predict_the_classes(yik_dict, doc_word_dict, pi_k, top_words_ids, theta_jk, den,
                                               dir_path)

        f = open('Y_predicted_values_smoothing' + Y_pred_filenames[counter], 'w')
        for p in Y_pred:
            f.write(str(p) + '\n')
        f.close()
