...
def main():
    ...
    # vocabulary_size_list = [len(word_freq_dict)]
    vocabulary_size_list = [50000]

    # pi_values_filenames = ['Top100_pi_values.csv']
    pi_values_filenames = ['Top50000_pi_values_smoothing.csv', 'Top50000_pi_values_smoothing.csv', 'Top50000_pi_values_smoothing.csv']
    # theta_values_filenames = ['Top100_theta_values.csv']
    theta_values_filenames = ['Top50000_theta_values-Part1_smoothing.csv',
                                             'Top50000_theta_values-Part2_smoothing.csv',
                                             'Top50000_theta_values-Part3_smoothing.csv']
