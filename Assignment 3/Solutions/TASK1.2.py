...
def logistic_regression(train_data, test_data, Y_train, Y_test, n_iterations, tolerance, learning_rate, flag):
    ...
    coeff, train_data, logistic_loss = gradient_descent(train_data, Y_train, learning_rate, n_iterations, tolerance, flag)
...
def lr_algorithm(ds, n_folds, n_iterations, tolerance, learning_rate, flag):
    # Split the dataset into training and cross validation set
...
def main():
    ...
    for dataset in datasets_list:
        ...
        tolerance = 0.01  # SELECT THE OPTIMAL VALUES
        learning_rate = 1e-3

        # Main Logistic Regression function
        accuracy_train, precision_train, recall_train, accuracy_test, precision_test, recall_test \
            = lr_algorithm(ds, n_folds, n_iterations, tolerance, learning_rate, flag)
        flag = False
