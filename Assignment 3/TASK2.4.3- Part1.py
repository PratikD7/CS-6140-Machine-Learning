...
# ================================================================================#
# Create freq of a particular key value pair of doc_word_freq dict
...
# ================================================================================#
# Get a list of dicts containing word-freq pair
...
def main():
    ...
    for vocabulary_size in vocabulary_size_list:
        ...
        pi_values = []
        data = load_csv('Top100_pi_values_MEvent.csv')
        data = numpy.array(data).tolist()
        for row in data:
        ...
        data = load_csv('Top100_theta_values_MEvent.csv')
